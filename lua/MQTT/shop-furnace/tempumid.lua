...
-- tempumid.lua
CNAME="shop/furnace" -- Client name 
...
-- tmr.create():alarm(1, TUPTEMP*1000, tmr.ALARM_AUTO, function() read_temp_hum(mqt) end)
 
-- -- Sends periodically a message to the monitor topic
-- tmr.create():alarm(4, TUPDATE*1000, tmr.ALARM_AUTO, function() send_mstatus("Sensor <"..HOSTNAME.."> Ready") print("Sensor <"..HOSTNAME.."> Ready") end)
-- tmr.create():alarm(1, tmr.ALARM_AUTO, function() read_temp_hum(mqt) end)
